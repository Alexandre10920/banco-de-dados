...
-- Qual é o erro? usamos > que 2005 ja que pediu acima de 2005__________________________________________________________
-- Correção:
...
-- Qual é o erro? Sul não é um estado__________________________________________________________
-- Correção:
...
-- Qual é o erro? usamos is null__________________________________________________________
-- Correção:
...
-- Qual é o erro? o nome é atores, não actor__________________________________________________________
-- Correção:
...
-- Qual é o erro? A falta do where__________________________________________________________
-- Correção
UPDATE filmes SET genero = 'Fantasia'
